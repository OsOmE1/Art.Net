...
public class ArtTodRequest() : ArtNetPacket(OpCodes.OpTodRequest)
{
    /// <summary>
    ...
    public new static ArtTodRequest FromData(ArtNetData data)
    {
        ...
        var packet = reader.ReadObject<ArtTodRequest>();
