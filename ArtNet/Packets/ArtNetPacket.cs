...
public class ArtNetPacket
{
    ...
    ///  ["A", "r", "t", "-", "N", "e", "t", 0x00]
    /// </value>
    [SkipBin2Object] protected byte[] Id;
    /// <summary>
    ...
    {
        Id = [65, 114, 116, 45, 78, 101, 116, 0]; // "Art-Net" as null terminated byte array
        OpCode = opCode;
    }
    ...
    public T Cast<T>(bool force = false)
    {
        ...
        if (typeof(T).GetCustomAttribute<OpCodeAttribute>(false) == null && !force)
        ...
        return (T)typeof(T).GetMethod("FromData")?.Invoke(null, [PacketData]);
    }
