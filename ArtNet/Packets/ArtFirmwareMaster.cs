...
public class ArtFirmwareMaster() : ArtNetPacket(OpCodes.OpFirmwareMaster)
{
    /// <summary>
    ...
    public new static ArtFirmwareMaster FromData(ArtNetData data)
    {
        ...
        var packet = reader.ReadObject<ArtFirmwareMaster>();
