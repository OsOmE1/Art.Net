...
public class ArtDataRequest() : ArtNetPacket(OpCodes.OpCommand)
{
    /// <summary>
    ...
    public new static ArtDataRequest FromData(ArtNetData data)
    {
        ...
        var packet = reader.ReadObject<ArtDataRequest>();
